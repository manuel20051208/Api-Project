...
API de inventario y ventas (`ApiJuegoInventario`) construida con Spring Boot 3.5 y Java 21. Base de datos PostgreSQL. Incluye módulos de **cupones**, **productos de segunda mano** (con imágenes Cloudinary y compras), **servicios ofrecidos** y **rankings** (top clientes/productos con materialized views + colores de interfaz por usuario) → [[Endpoints API]] · [[Esquema de Base de Datos]].
